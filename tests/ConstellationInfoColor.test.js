// constellationInfo.test.js - unit test

// const getConstellationInfo = require('../js/util/constellationAnimation.js');

describe('Test getConstellationInfo function', () => {
    it('should return the correct information and color for a valid constellation', () => {
      expect(getConstellationInfo('Pisces')).toEqual([
      ...
      expect(getConstellationInfo('Leo')).toEqual([
    ...
    it('should return default values for an unknown constellation', () => {
      expect(getConstellationInfo('Unknown')).toEqual([
