...
export async function startDialogueSequence(welcomeMsg, speakerName) {
  ...
  function promptAstrology() {
    ...
    writeToDialogue(
      "Would you like to know what the stars say about your future?",
      speakerName,
      null,
      () => {
  ...
  function getBirthMonth() {
    ...
    let cancelTyping = writeToDialogue(
      "Now tell me, what month were you born?"
    );
  ...
  function getBirthYear() {
    let cancelTyping = writeToDialogue(
      "Oh! Do tell me the year you were born!"
    );
  ...
  async function showPred() {
    ...
    if (userMood == "Powell") {
      curText =
        "The holy—— uh, wait... well, oops, Professor Powell answered your call...";
      response = [
        "Hello, kids!",
    ...
    writeToDialogue(
      ...
      () => {
        ...
        writeToDialogue(
          response,
          userMood === "Powell" ? "Powell " : speakerName,
          () => {
